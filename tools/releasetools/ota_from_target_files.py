...
""" % bcb_dev)
  ...
  if GetBuildProp("ro.aim.display.version", OPTIONS.info_dict) is not None:
    buildid = GetBuildProp("ro.aim.display.version", OPTIONS.info_dict)
    ...
    device = GetBuildProp("ro.aim.device", OPTIONS.info_dict)
